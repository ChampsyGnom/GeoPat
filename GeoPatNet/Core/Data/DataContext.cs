...
namespace Emash.GeoPatNet.Data
{
    public class DataContext : IDataContext
    {
        ...
        public DbSet<InfContactCls>  InfContactClss
        {
            get;
            set;
        }
        ...
        public DbSet<InfDocCls>  InfDocClss
        {
            get;
            set;
        }
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InfCodeDoc>().HasKey(t => t.Id);
            modelBuilder.Entity<InfCodeDoc>().Property(t => t.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<InfContactCls>().HasRequired<InfCls>(c => c.InfCls).WithMany(t => t.InfContactClss);
            modelBuilder.Entity<InfContactCls>().HasRequired<InfContact>(c => c.InfContact).WithMany(t => t.InfContactClss);
            modelBuilder.Entity<InfContactCls>().ToTable("inf_contact_cls", "inf");
            modelBuilder.Entity<InfContactCls>().Property(t => t.Id) .HasColumnName("inf_contact_cls__id");
            modelBuilder.Entity<InfContactCls>().Property(t => t.Id).IsRequired();
            modelBuilder.Entity<InfContactCls>().Property(t => t.InfClsId) .HasColumnName("inf_cls__id");
            modelBuilder.Entity<InfContactCls>().Property(t => t.InfClsId).IsRequired();
            modelBuilder.Entity<InfContactCls>().Property(t => t.InfContactId) .HasColumnName("inf_contact__id");
            modelBuilder.Entity<InfContactCls>().Property(t => t.InfContactId).IsRequired();
            modelBuilder.Entity<InfContactCls>().HasKey(t => t.Id);
            modelBuilder.Entity<InfContactCls>().Property(t => t.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<InfStyleRule>().Property(t => t.Field) .HasColumnName("inf_style_rule__field");
            modelBuilder.Entity<InfStyleRule>().Property(t => t.Field).HasMaxLength(50);
            ...
            modelBuilder.Entity<InfStyleRule>().Property(t => t.Critere) .HasColumnName("inf_style_rule__critere");
            modelBuilder.Entity<InfStyleRule>().Property(t => t.Critere).HasMaxLength(200);
