...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfCodePrestataire 
    {
        ...
        public virtual ObservableCollection<InfPrestataire> InfPrestataires
        {
            get;
            set;
        }
        ...
        [ForeignKeyAttribute("INF_CD_PRESTATAIRE__CD_PRESTATAIRE","JOIN_o1028")]
		...
		public InfCodePrestataire ()
		{
            this.InfPrestataires = new ObservableCollection<InfPrestataire>();
		}
