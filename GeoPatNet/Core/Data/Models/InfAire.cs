...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfAire 
    {
        ...
        [ForeignKeyAttribute("INF_AIRE__INF_AIRE_PARKING","JOIN_o907")]
        [ForeignKeyAttribute("INF_AIRE__INF_AIRE_PRESTATAIRE","JOIN_o909")]
        [ForeignKeyAttribute("INF_AIRE__INF_AIRE_SERVICE","JOIN_o905")]
