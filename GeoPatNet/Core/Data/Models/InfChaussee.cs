...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o912")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o952")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o914")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o916")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o918")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o920")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o922")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o924")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o926")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o928")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o930")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o932")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o934")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o936")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o938")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o940")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o942")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o944")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o946")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o948")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o950")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
