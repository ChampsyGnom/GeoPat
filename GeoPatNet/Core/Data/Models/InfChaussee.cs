...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o951")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o991")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o953")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o955")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o957")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o959")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o961")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o963")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o965")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o967")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o969")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o971")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o973")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o975")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o977")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o979")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o981")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o983")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o985")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o987")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o989")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
