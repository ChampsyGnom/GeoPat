...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o948")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o988")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o950")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o952")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o954")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o956")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o958")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o960")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o962")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o964")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o966")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o968")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o970")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o972")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o974")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o976")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o978")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o980")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o982")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o984")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o986")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
