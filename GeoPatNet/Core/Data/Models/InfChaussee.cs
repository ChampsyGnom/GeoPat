...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o915")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o955")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o917")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o919")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o921")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o923")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o925")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o927")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o929")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o931")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o933")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o935")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o937")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o939")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o941")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o943")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o945")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o947")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o949")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o951")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o953")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
