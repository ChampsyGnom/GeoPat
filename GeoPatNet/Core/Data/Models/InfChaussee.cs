...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o824")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o864")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o826")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o828")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o830")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o832")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o834")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o836")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o838")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o840")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o842")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o844")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o846")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o848")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o850")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o852")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o854")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o856")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o858")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o860")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o862")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
