...
namespace Emash.GeoPatNet.Data.Models
{
    ...
    public class InfChaussee 
    {
        ...
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ACCIDENT","JOIN_o827")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AIRE","JOIN_o867")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_AMENAGEMENT","JOIN_o829")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PR_OLD","JOIN_o831")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BIFURCATION","JOIN_o833")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_BRETELLE","JOIN_o835")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_CLIMAT","JOIN_o837")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_ECLAIRAGE","JOIN_o839")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_GARE","JOIN_o841")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_OCCUPATION","JOIN_o843")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PAVE_VOIE","JOIN_o845")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PK","JOIN_o847")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_PT_SING","JOIN_o849")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPARTITION_TRAFIC","JOIN_o851")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_REPERE","JOIN_o853")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECTION_TRAFIC","JOIN_o855")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SECURITE","JOIN_o857")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_SENSIBLE","JOIN_o859")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TALUS","JOIN_o861")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TPC","JOIN_o863")]
        [ForeignKeyAttribute("INF_CHAUSSEE__INF_TR_DEC","JOIN_o865")]
        [ControlType(ControlType.None)]
        [AllowNull(false)]
        public Int64 Id
        {
